...
const translations = {
  "zh-Hant": {
    ...
    sourceLanguage: "原文語言", targetLanguage: "翻譯目標語言", translationType: "處理方案", translationTypeStd: "Standard（Groq Whisper + GPT-OSS 120B）", translationTypePro: "Premium（Groq Whisper + Gemini）", translationTypePrivate: "Private（本機 Whisper + Qwen3 14B）", transcriptionMode: "轉譯模式", modeAccurate: "高精度（較慢）", modeFast: "快速", autoDetect: "自動偵測", languageEnglish: "英文", languageJapanese: "日文", languageKorean: "韓文", languageThai: "泰文", languageTraditionalChinese: "繁體中文",
  ...
  en: {
    ...
    sourceLanguage: "Source language", targetLanguage: "Target language", translationType: "Processing profile", translationTypeStd: "Standard (Groq Whisper + GPT-OSS 120B)", translationTypePro: "Premium (Groq Whisper + Gemini)", translationTypePrivate: "Private (local Whisper + Qwen3 14B)", transcriptionMode: "Transcription mode", modeAccurate: "High accuracy (slower)", modeFast: "Fast", autoDetect: "Auto detect", languageEnglish: "English", languageJapanese: "Japanese", languageKorean: "Korean", languageThai: "Thai", languageTraditionalChinese: "Traditional Chinese",
  ...
  ja: {
    ...
    sourceLanguage: "原文の言語", targetLanguage: "翻訳先の言語", translationType: "処理プロファイル", translationTypeStd: "Standard（Groq Whisper + GPT-OSS 120B）", translationTypePro: "Premium（Groq Whisper + Gemini）", translationTypePrivate: "Private（ローカル Whisper + Qwen3 14B）", transcriptionMode: "文字起こしモード", modeAccurate: "高精度（低速）", modeFast: "高速", autoDetect: "自動検出", languageEnglish: "英語", languageJapanese: "日本語", languageKorean: "韓国語", languageThai: "タイ語", languageTraditionalChinese: "繁体字中国語",
  ...
  ko: {
    ...
    sourceLanguage: "원문 언어", targetLanguage: "번역 언어", translationType: "처리 프로필", translationTypeStd: "Standard(Groq Whisper + GPT-OSS 120B)", translationTypePro: "Premium(Groq Whisper + Gemini)", translationTypePrivate: "Private(로컬 Whisper + Qwen3 14B)", transcriptionMode: "전사 모드", modeAccurate: "고정밀(느림)", modeFast: "빠름", autoDetect: "자동 감지", languageEnglish: "영어", languageJapanese: "일본어", languageKorean: "한국어", languageThai: "태국어", languageTraditionalChinese: "번체 중국어",
